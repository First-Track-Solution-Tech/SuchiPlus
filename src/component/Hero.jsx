    ...
    <section className="h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
        ...
        <p className="mt-4 text-base md:text-xl text-white">
          Starts at ₹199. Cancel at any time.
        </p>
        ...
        <div className="mt-6 flex flex-col md:flex-row gap-4 w-full max-w-xl">
          ...
          <Link
          to ="/Account" className="bg-blue-600 px-6 md:px-8 py-3 md:py-4 rounded text-lg md:text-xl font-semibold text-white hover:bg-blue-700 transition">
            Get Started →
          </Link>
